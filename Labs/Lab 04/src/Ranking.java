...
public class Ranking {
	...
	public static Vaulter[] addVaulterToRankings(Vaulter[] oldRankings, Vaulter newVaulter) {
		int newNumVaulters = oldRankings.length +1 ; // delete +1
...
//			System.out.println(newRankings[curVaulterIndex].getName());
			curVaulterIndex++; // add this
//			System.out.println(curVaulterIndex);
		...
		for (int i = curVaulterIndex; i < newNumVaulters ; i++) {
//			System.out.println("newRankings at i: " + newRankings[i]);
